...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2020 at 12:50 PM
...
(3, 'Coats', 150),
(4, 'Jackets', 200),
(5, 'House Cleaning', 1000),
(6, 'Compound Cleaning', 1000),
(7, 'Carpet Cleaning', 500);
...
(22, 4, 9999, 12, '2018-11-14', '0000-00-00', 'F', 200),
(23, 5, 9999, 12, '2018-11-14', '0000-00-00', 'F', 700),
(24, 6, 10000, 15, '2020-01-15', '2020-01-17', 'F', 40);
...
(10000, 'steve', 'steves', '0712345321', 'Nakuru, Kenya', 1, 40, 'steve@gmail.com', 'steve', '81dc9bdb52d04dc20036dbd8313ed055', 'M'),
(10001, 'user', 'user1', '0712345321', 'Langalanga', 1, 0, 'user@gmail.com', 'user1', '202cb962ac59075b964b07152d234b70', 'M');
...
--
ALTER TABLE `member`
  MODIFY `memberId` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;
...
--
ALTER TABLE `regisitem`
  MODIFY `regisId` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
